...
the outcome of new data. I applied the model to the smallTest dataset. I have
no way to assess the error rate because the true classification was not supplied.
However, if this model were connected to a "digital personal trainer", it would
be supplying advice 13 times and saying "great job" 7 times!
```{r, echo=FALSE}
